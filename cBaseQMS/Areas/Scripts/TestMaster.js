...
function CheckedTestMaster(checkedRadio, appTestMasterName, appDescription, elem) {
    if (elem === "Delete") {
        ...
        fetchLocationAndPartGridData(checkedRadio);
    }
    ...
    $.ajax({
        ...
        success: function (Data) {
            ...
            if (!Data.Success) {
                ...
                fetchGridDataAfterUpdate(Data.testMasterId, val);
            }
...
function fillTests() {
    ...
    $.ajax({
        ...
        success: function (response) {
            ddlTests.empty().append('<option selected="selected" value="">All Tests*</option>').append('<option  value="">*All Unassigned Tests</option>');
...
function GetAllPartMaster() {
    ...
    ddlPartMaster.empty().append('<option selected="selected" value="" disabled = "disabled">Loading.....</option>');
    $.ajax({
        type: "GET",
    ...
    $.ajax({
        ...
        success: function (Data) {
            ...
            if (!Data.Success) {
                ...
                $("#testMasterName").val("");
                $("#testMasterDesc").val("");
                $("#alertSucess").text(Data.SuccessMessage);
                $(".alert-success").show().delay(1000).fadeOut(200);
            }
...
function fetchGridData(t) {
    $("#tblTestMasterLists").GridUnload();
    loadGrid();
    var URL = "TestMaster/GetAllTestMastersByTest?testid=" + t;
    var gridArrayData = [];
    $.ajax({
        url: URL,
...
function fetchGridDataAfterUpdate(t, o) {
    $("#tblTestMasterLists").GridUnload();
    loadGrid();
    var tv = 0;
    var URL = "TestMaster/GetAllTestMastersByTest?testid=" + tv;
    var gridArrayData = [];
    $.ajax({
        url: URL,
        success: function (result) {
...
function fetchLocationAndPartGridData(t) {
    $("#tblLocationNPart").GridUnload();
    loadPartAndLocationGrid();
    disableControls(false);
    var URL = "TestMaster/GetAllLocationAndPartMasterMapping?testMasterid=" + t;
    var gridArrayData = [];
    $.ajax({
        url: URL,
        success: function (result) {
...
function SavePartAndLocation() {
    ...
    $.ajax({
        ...
        success: function (Data) {
            // console.log(Data);
            if (Data.Success) {
                fetchLocationAndPartGridData(Data.testMasterId);
                $("#alertSucess").text(Data.msg);
                $(".alert-success").show().delay(1000).fadeOut(200);
                $("#btnPartAndLocation").disabled(true);
            }

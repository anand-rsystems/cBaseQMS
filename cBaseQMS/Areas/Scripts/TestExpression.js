$(document).ready(function () {
    ...
    $("#TestMaster").change(function () {
        ...
        $.ajax({
            type: 'GET',
            //url: '/cBaseQMS/TestExpression/LoadTestsByTestMasterId',
            url: $("#hdnLoadTestURL").val(),
    ...
    $("#ddlComponent").change(function () {
        ...
        var promise = AjaxCall('GET', $("#hdnLoadComponentItemsURL").val(), data);
    ...
    $("#ddlTests").change(function () {
        ...
        var promise = AjaxCall('GET', $("#hdnGetExpressionURL").val(), data);
        var id = '';
